...
export interface IConnectionService {
    ...
    displayFollowings(managerId:objId):Promise<Array<connectionResponse>|null>;
    ...
    searchInFollowers(managerId:objId,name:string):Promise<connectionResponse[]|null>;
    searchInFollowings(managerId:objId,name:string):Promise<connectionResponse[]|null>;
};
